...
public class BoardController {
	...
	"0") Integer page, @RequestParam(required = false, defaultValue = "5") Integer size) throws Exception{
		try {
	...
	public String getBaordViewPage(Model model, BoardRequestDto boardRequestDto) throws Exception{
